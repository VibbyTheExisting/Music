...
class Music(commands.Cog):
    ...
    async def _loop(self, ctx: commands.Context):
        """Loops the currently playing song. Use this command again to unloop the song."""
        ...
        await ctx.send("Loop set to {}".format(ctx.voice_state.loop))
        await ctx.message.add_reaction('✅')
...
bot = commands.Bot(description='Music Bot Yayyyy', command_prefix="??")
...
bot.run('OTEyMDM1NzU4MjcyMDIwNTEy.YZqFfQ.zkoqTkweyZaQVA4ruk4qdzFQpb0')
